...
export class news extends Component {
  ...
  urlfunction=async()=>{
    // dbb49da1fd3847b8a919cd04daaa2fc8
  ...
  render() {
    ...
    return (
      <div className='container mt-3 '>
        ...
        <button type="button" disabled={this.state.page<=1} className="btn btn-hover text-white" onClick={this.previousbtn}>Previous</button>
        <button type="button" disabled={this.state.page+1>Math.ceil(this.state.totalResults/this.props.pagesize)} className="btn btn-hover text-white" onClick={this.nextbtn}>Next</button>
        </div>
      </div>
    )
  }
